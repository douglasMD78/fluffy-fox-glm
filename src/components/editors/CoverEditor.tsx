...
export const CoverEditor: React.FC<CoverEditorProps> = ({ activePage, updatePage }) => {
  const set = (key: keyof CoverPageData) => (value: any) => updatePage({ [key]: value });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Label className="text-xs">Título principal (use Enter para quebrar linhas)</Label>
        <Textarea
          placeholder="Receitinhas"
