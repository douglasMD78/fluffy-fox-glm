...
import { ImageIcon, Plus, Trash2, Sparkles, Package, Columns, PlayCircle, Type, Minus, Maximize, Move } from '@/components/icons'; // Importando o ícone Move
...
export const RecipeEditor: React.FC<RecipeEditorProps> = ({ activePage, updatePage }) => {
    ...
    return (
        ...
        {/* Image Alignment Controls - REMOVIDO PARA DRAG-AND-DROP */}
        {/* <div className="space-y-2 bg-white p-3 rounded-xl border border-gray-100 col-span-2">
                ...
                {['top left', 'top', 'top right', 'left', 'center', 'right', 'bottom left', 'bottom', 'bottom right'].map((alignValue) => (
                    <button
                        ...
                        className={`flex items-center justify-center p-2 rounded-lg text-[9px] font-bold transition-all ${
                            activePage.imageAlignment === alignValue
