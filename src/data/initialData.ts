...
export const PDF_LUIZA_DATA = [
    ...
    },
    {
        ...
        yield: "1 pote",
        nutrition: {},
        macroNote: "Tabela nutricional não aplicável (condimento de baixo valor calórico por porção, variando apenas conforme a quantidade de azeite ingerida).",
        ingredientGroups: [
            {
                title: "Ingredientes",
        ...
        prepSteps: "Corte: Descasque e fatie as cebolas em rodelas bem finas (quanto mais fina, melhor a textura e absorção do tempero).\n\nTempere: Em um recipiente grande, coloque as cebolas e adicione o azeite, o vinagre e os temperos secos (chimichurri, pimenta, sal e alho).\n\nHidrate: Despeje a água morna sobre as cebolas temperadas.\n\nMisture: Mexa bem para que todos os ingredientes se incorporem.\n\nCurta: Transfira para um pote com tampa. Embora possa ser consumida na hora, o ideal é deixar descansar na geladeira de um dia para o outro para apurar o sabor.",
        tips: "",
        ...
        tipPlacement: 'footer',
        storagePlacement: 'footer',
        nutritionDisplayStyle: 'hidden',
        titleAlignment: null,
    },
    {
        id: 'p_salada_refogada_pratica',
        type: TEMPLATES.RECIPE,
        ...
        yield: "Variável",
        nutrition: {},
        macroNote: "Tabela nutricional variável conforme a quantidade servida, mas é uma opção de baixíssima caloria e rica em nutrientes.",
        ingredientGroups: [
            {
                title: "Ingredientes",
    ...
    },
    {
        ...
        code: "LM, LT",
        yield: "1 potinho",
        nutrition: { cal: "19", prot: "8.5g", carb: "16.0g", fat: "9.0g" },
        macroNote: "Tabela nutricional aproximada por potinho.",
        ingredientGroups: [
            {
                title: "Base",
